...
class MetadataType:
    ...
    Members:
      ...
      METADATA_DICOM
    """
    METADATA_DICOM: typing.ClassVar[MetadataType]  # value = <MetadataType.METADATA_DICOM: 2>
    METADATA_I2S: typing.ClassVar[MetadataType]  # value = <MetadataType.METADATA_I2S: 1>
    METADATA_UNDEFINED: typing.ClassVar[MetadataType]  # value = <MetadataType.METADATA_UNDEFINED: 0>
    __members__: typing.ClassVar[dict[str, MetadataType]]  # value = {'METADATA_UNDEFINED': <MetadataType.METADATA_UNDEFINED: 0>, 'METADATA_I2S': <MetadataType.METADATA_I2S: 1>, 'METADATA_DICOM': <MetadataType.METADATA_DICOM: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class Slide:
    ...
    def read_associated_image(self, image_label: str) -> numpy.typing.NDArray[numpy.uint8]:
        ...
        """
    @typing.overload
    def read_slide_tile(self, layer_index: int = 0, tile_index: int = 0) -> numpy.typing.NDArray[numpy.uint8]:
        ...
    @typing.overload
    def read_slide_tile(self, layer_index: int = 0, x_tile_index: int = 0, y_tile_index: int = 0) -> numpy.typing.NDArray[numpy.uint8]:
        ...
    def read_slide_tile_channels(self, layer_index: int = 0, tile_index: int = 0) -> numpy.typing.NDArray[numpy.uint8]:
        """
